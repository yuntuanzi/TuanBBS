...
yield _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/www/wwwroot/www.mua.cx/admin/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
